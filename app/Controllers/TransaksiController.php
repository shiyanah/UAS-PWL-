...
class TransaksiController extends BaseController
{
    ...
    public function buy()
    {
        if ($this->request->getPost()) {
            ...
            // DISESUAIKAN: Ambil teks lengkap kelurahan dan layanan dari hidden input
            ...
            $dataPesanan = [
                ...
                'status_pesanan' => 'menunggu pembayaran', // DISESUAIKAN: menggunakan 'status_pesanan' (setelah migrasi baru)
            ...
            foreach ($this->cart->contents() as $value) {
                $dataFormDetail = [
                    ...
                    'jumlah' => $value['qty'], // DISESUAIKAN: menggunakan 'jumlah'
