        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="<?= base_url('NiceAdmin/assets/img/messages-2.jpg') ?>" alt="Profile" class="rounded-circle">
                    <h2><?= esc($username ?? 'Nama Pengguna') ?></h2>
                    <h3>Web Designer</h3>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8"><?= esc($username ?? 'Nama Pengguna') ?></div>
                            </div>
...
</section> History Transaksi Pembelian <strong><?= $username ?? 'Pengguna' ?></strong>
<hr>
